...
EMSCRIPTEN_BINDINGS(FissionOpt) {
  emscripten::class_<Fission::Settings>("FissionSettings")
    ...
    .property("generationMultiplier", &Fission::Settings::generationMultiplier)
    .property("heatCapacity", &Fission::Settings::heatCapacity)
    .property("heatMultiplier", &Fission::Settings::heatMultiplier)
    .property("heatMultiplierCap", &Fission::Settings::heatMultiplierCap)
    .property("moderatorFEMultiplier", &Fission::Settings::moderatorFEMultiplier)
    .property("moderatorHeatMultiplier", &Fission::Settings::moderatorHeatMultiplier)
    .property("FEGenerationMultiplier", &Fission::Settings::FEGenerationMultiplier)
